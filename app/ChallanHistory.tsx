...
export function ChallanHistory({ challans, onPaymentComplete }: ChallanHistoryProps) {
  ...
  const handlePaymentSuccess = async (challanId: string) => {
    setProcessingPayment(true)
    try {
      await onPaymentComplete(challanId)
            ...
            <Table>
              ...
              <TableBody>
                {sortedChallans.map((challan) => (
                  <TableRow key={challan.id} className="border-t border-gray-700">
                      ...
                      <div className="flex justify-end gap-2">
                        ...
                        {challan.status === "Unpaid" && (
                          <Button 
                            variant="outline"
                            size="sm"
                            className="border-green-600 text-green-400 hover:bg-green-900 hover:text-green-200"
                            onClick={() => {
